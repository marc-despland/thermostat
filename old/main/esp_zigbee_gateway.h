...
#define ESP_ZB_PRIMARY_CHANNEL_MASK     (1l << 25)  /* Canal 25 recommandé */
...
#define ESP_TEMP_SENSOR_MIN_VALUE           (500)   /* Min temperature in 0.01°C (5°C) */
#define ESP_TEMP_SENSOR_MAX_VALUE           (3000)  /* Max temperature in 0.01°C (30°C) */
#define ESP_TEMP_SENSOR_TOLERANCE           (100)   /* Temperature tolerance in 0.01°C (1°C) */

/* Default Thermostat Values */
#define DEFAULT_LOCAL_TEMPERATURE           (2000)  /* Default 20°C */
#define DEFAULT_OCCUPIED_HEATING_SETPOINT   (2100)  /* Default 21°C */
#define DEFAULT_MIN_HEAT_SETPOINT_LIMIT     (500)   /* 5°C */
#define DEFAULT_MAX_HEAT_SETPOINT_LIMIT     (3000)  /* 30°C */
